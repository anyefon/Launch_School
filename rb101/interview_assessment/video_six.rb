...
# Your method will return the index 3, because at the 3rd position of the array, the sum,
...
# Output: index for which  sums of integers left and right equal

# Algorithm
# Iterate through the array
#   For each index, check if the sum of elements from index 0 up to current index and index + 1 up to last index equal
#   If so, return index
